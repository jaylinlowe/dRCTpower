...
of the RCT estimates. These estimates are based on splitting an
auxiliary dataset into different subgroups and calculating the necessary
sample size if the RCT sample were to resemble that subgroup.

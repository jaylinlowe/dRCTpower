...
Imagine that we are planning an experiment to test the effectiveness of a new algebra curriculum. We will determine effectiveness based on the TAKS passing rates and plan to use `schools` as an auxiliary data set to improve precision when analyzing our RCT. 
